...
check_ports_occupied() {
    ...
    if [[ -n $port_check_output ]]; then
        echo "+++++++++++ ERROR ++++++++++++++++++++++"
        echo "Appsmith requires ports 8102 & 8103 to be open. Please shut down any other service(s) that may be running on these ports."
